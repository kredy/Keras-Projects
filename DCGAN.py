...
class GAN:
    ...
    def generator(self):
        ...
        layer = BatchNormalization()(layer)
        layer = LeakyReLU(alpha=0.2)(layer)
        layer = Conv2DTranspose(1, (2,2), strides=(1,1), padding='same')(layer)
        layer = BatchNormalization()(layer)
        layer = LeakyReLU(alpha=0.2)(layer)
    ...
    def discriminator(self):
        ...
        layer = Conv2D(16, (3,3), strides=(1,1), padding='valid')(inputs)
        layer = BatchNormalization()(layer)
        layer = LeakyReLU(alpha=0.2)(layer)
        layer = Dropout(0.3)(layer)
        layer = Conv2D(16, (3,3), strides=(1,1), padding='valid')(layer)
        layer = BatchNormalization()(layer)
        layer = LeakyReLU(alpha=0.2)(layer)
        layer = Dropout(0.3)(layer)
        layer = Conv2D(16, (3,3), strides=(1,1), padding='valid')(layer)
...
def main():
    ...
    train(generator, discriminator_train, gan_model, 2000, 128, x_train)
